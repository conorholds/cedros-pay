import type { SubscriptionStatusResponse, CreditsRequirement, BillingInterval, PaymentResult } from '../types';
/**
...
export declare function useCreditsSubscription(): {
    ...
    subscriptionStatus: import("../types").SubscriptionStatus | null;
