 ...
 *
 * This is kept separate from redirect checkout so the mobile-native contract
 * stays explicit.
 */
...
export type SubscriptionSessionResponse = RedirectCheckoutSubscriptionSessionResponse | PaymentSheetSubscriptionSessionResponse;
/**
