...
exports.usePaymentMode = usePaymentMode;
 ...
 */
function usePaymentMode(resource, items) {
    ...
    return (0, react_1.useMemo)(() => {
        ...
        const isCartMode = (0, cartHelpers_1.isCartCheckout)(items);
        // Resolve the effective resource for single-item payments
        // Priority: explicit resource prop, then single item from array
        const effectiveResource = resource || (items?.length === 1 ? items[0].resource : '');
        return {
            isCartMode,
            effectiveResource,
        };
...
//# sourceMappingURL=usePaymentMode.js.map