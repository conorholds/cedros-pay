...
function generateCorrelationId() {
    ...
    const uuid = (0, uuid_1.generateUUID)().slice(0, 12); // First 12 chars for brevity
...
function enrichError(error, options = {}) {
    ...
    return {
        ...
        userAgent: `React Native ${react_native_1.Platform.OS || 'unknown'}`,
 ...
 * ```
 */
function createErrorReporter(defaultTags) {
