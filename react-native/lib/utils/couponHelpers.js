...
exports.parseCouponCodes = parseCouponCodes;
exports.formatCouponCodes = formatCouponCodes;
exports.calculateDiscountPercentage = calculateDiscountPercentage;
exports.stackCheckoutCoupons = stackCheckoutCoupons;
/**
 ...
 * // Returns: []
 */
function parseCouponCodes(metadata) {
 ...
 * // Returns: "SITE10, CRYPTO5AUTO, SAVE20"
 */
function formatCouponCodes(coupons, separator = ", ") {
 ...
 * // Returns: 25.0
 */
function calculateDiscountPercentage(originalAmount, discountedAmount) {
    if (originalAmount <= 0)
        return 0;
 ...
 * // Returns: 70.50
 */
function stackCheckoutCoupons(subtotal, checkoutCoupons) {
