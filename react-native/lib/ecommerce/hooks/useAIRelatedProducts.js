...
exports.useAIRelatedProducts = useAIRelatedProducts;
...
function useAIRelatedProducts(options = {}) {
    ...
    const [relatedProductIds, setRelatedProductIds] = (0, react_1.useState)(null);
    const [reasoning, setReasoning] = (0, react_1.useState)(null);
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    // Track current request to handle race conditions
    const requestIdRef = (0, react_1.useRef)(0);
    const fetchRecommendations = (0, react_1.useCallback)(async () => {
