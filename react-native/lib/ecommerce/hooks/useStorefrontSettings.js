...
exports.useStorefrontSettings = useStorefrontSettings;
...
function useStorefrontSettings(_options = {}) {
    ...
    const [isLoading, setIsLoading] = (0, react_1.useState)(!!adapter?.getStorefrontSettings);
    (0, react_1.useEffect)(() => {
...
//# sourceMappingURL=useStorefrontSettings.js.map