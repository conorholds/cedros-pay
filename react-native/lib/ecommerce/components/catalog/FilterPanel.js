...
function FilterPanel({ facets, value, onChange, onClear, style, enabledFilters, }) {
    ...
    return (<react_native_1.View style={[styles.container, style]}>
      ...
      {showTags && tags.length ? (<react_native_1.View style={styles.section}>
          ...
          <react_native_1.ScrollView style={styles.tagsList} showsVerticalScrollIndicator={false}>
            {tags.map((t) => {
