...
exports.CedrosThemeProvider = CedrosThemeProvider;
exports.useCedrosTheme = useCedrosTheme;
exports.useCedrosThemeOptional = useCedrosThemeOptional;
...
const CedrosThemeContext = (0, react_1.createContext)(null);
function mergeTokens(mode, overrides) {
...
function CedrosThemeProvider({ initialMode = 'light', overrides, unstyled = false, children, }) {
    ...
    const [stableOverrides, setStableOverrides] = (0, react_1.useState)(overrides);
    const prevOverridesRef = (0, react_1.useRef)(overrides);
    ...
    (0, react_1.useEffect)(() => {
        ...
        const valuesChanged = !overrides || !prevOverridesRef.current
            ...
            : Object.keys({ ...overrides, ...prevOverridesRef.current }).some((key) => overrides[key] !== prevOverridesRef.current?.[key]);
        if (valuesChanged) {
    ...
    return (<CedrosThemeContext.Provider value={value}>
      {children}
 ...
 */
function useCedrosTheme() {
    const context = (0, react_1.useContext)(CedrosThemeContext);
    if (!context) {
 ...
 */
function useCedrosThemeOptional() {
    return (0, react_1.useContext)(CedrosThemeContext);
}
