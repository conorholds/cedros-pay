...
import { detectLocale, loadLocale, createTranslator } from './index';
 ...
 * ```
 */
export function useTranslation(requestedLocale) {
 ...
 * ```
 */
export function useLocalizedError(errorCode, includeAction = true) {
