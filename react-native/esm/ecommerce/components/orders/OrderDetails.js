...
export function OrderDetails({ order, onBack, style }) {
      ...
      <CardContent style={styles.content}>
        <View style={styles.header}>
          ...
          <View style={styles.actions}>
            ...
            {onBack ? (<Button variant="outline" size="sm" onPress={onBack}>
                Back
              </Button>) : null}
          </View>
        </View>
        ...
        <View style={styles.itemsList}>
          {order.items.map((it, idx) => (<View key={`${it.title}-${idx}`} style={styles.itemRow}>
        ...
        {(order.receiptUrl || order.invoiceUrl) ? (<View style={styles.linksRow}>
            {order.receiptUrl ? (<Button variant="ghost" size="sm" onPress={() => handleOpenLink(order.receiptUrl)}>
                Receipt
              </Button>) : null}
            {order.invoiceUrl ? (<Button variant="ghost" size="sm" onPress={() => handleOpenLink(order.invoiceUrl)}>
                Invoice
              </Button>) : null}
          </View>) : null}
      </CardContent>
