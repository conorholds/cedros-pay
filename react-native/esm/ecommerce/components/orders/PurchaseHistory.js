...
export function PurchaseHistory({ orders, onSelectOrder, style }) {
    ...
    return (<View style={[styles.container, style]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        {sortedGroups.map(([monthKey, monthOrders]) => (<View key={monthKey} style={styles.monthGroup}>
            <Text style={styles.monthHeader}>{monthKey}</Text>
            <View style={styles.ordersList}>
              {monthOrders.map((order) => (<Card key={order.id} style={styles.orderCard}>
                  <CardContent style={styles.orderContent}>
                    ...
                    {onSelectOrder && (<View style={styles.actionRow}>
                        <Text style={styles.viewDetails} onPress={() => onSelectOrder(order)}>
                          View Details →
                        </Text>
                      </View>)}
                  </CardContent>
