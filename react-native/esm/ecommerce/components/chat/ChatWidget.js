...
export function ChatWidget({ title = 'Chat Support', subtitle = 'How can we help you today?', position = 'bottom-right', style, onSendMessage, }) {
        ...
        <View style={styles.modalOverlay}>
          <Animated.View style={[
            ...
            <View style={styles.header}>
              ...
              <TouchableOpacity onPress={() => setIsOpen(false)} style={styles.closeButton} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
