...
export function FAQItem({ faq, style, expanded: controlledExpanded, defaultExpanded = false, onExpandedChange, showKeywords = false, questionStyle, answerStyle, keywordStyle, keywordTextStyle, }) {
    ...
    return (<View style={[styles.container, style]}>
      <TouchableOpacity onPress={handleToggle} style={styles.header} activeOpacity={0.7} accessibilityRole="button" accessibilityState={{ expanded }}>
      ...
      {expanded && (<View style={styles.content}>
          ...
          {showKeywords && faq.keywords && faq.keywords.length > 0 && (<View style={styles.keywordsContainer}>
              {faq.keywords.map((keyword) => (<View key={keyword} style={[styles.keywordBadge, keywordStyle]}>
