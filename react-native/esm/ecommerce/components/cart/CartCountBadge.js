...
export function CartCountBadge({ onPress, style, badgeStyle, }) {
    const cart = useCart();
    const count = cart.count;
    if (count === 0) {
        return null;
    }
    return (<TouchableOpacity onPress={onPress} activeOpacity={0.7} style={[styles.container, style]}>
...
export function MiniCart({ onPress, showTotal = true, style, }) {
    const cart = useCart();
    ...
    return (<TouchableOpacity onPress={onPress} activeOpacity={0.7} style={[styles.miniCartContainer, style]}>
      <View style={styles.miniCartContent}>
        ...
        <View style={styles.miniCartInfo}>
          ...
          {showTotal && (<Text style={styles.miniCartTotal}>
