...
export function SortDropdown({ value, onChange, options = ['featured', 'priceAsc', 'priceDesc', 'newest', 'bestselling'], style, }) {
        ...
        <View style={styles.overlay}>
          <View style={styles.content}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              {options.map((option) => (<TouchableOpacity key={option} style={[
                styles.option,
