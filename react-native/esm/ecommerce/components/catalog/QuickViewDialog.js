...
export function QuickViewDialog({ product, open, onOpenChange, onViewDetails, onAddToCart, style, }) {
      ...
      <DialogContent style={[styles.content, style]}>
        <DialogHeader>
          <DialogTitle style={styles.titleRow}>
            ...
            {onViewDetails ? (<TouchableOpacity onPress={() => onViewDetails(product.slug)}>
