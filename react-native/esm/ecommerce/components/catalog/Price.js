...
export function Price({ amount, currency, compareAt, size = 'default', style, textStyle, }) {
    ...
    return (<View style={[styles.container, style]}>
      ...
      {isSale ? (<Text style={[styles.compareAt, size === 'sm' ? styles.compareAtSm : styles.compareAtDefault]}>
