...
export function Accordion({ children, type = 'single', value: controlledValue, defaultValue, onValueChange, collapsible = true, }) {
...
export const AccordionItem = React.forwardRef(({ children, style, ...props }, ref) => (<View ref={ref} style={[styles.item, style]} {...props}>
      {children}
    </View>));
AccordionItem.displayName = 'AccordionItem';
export const AccordionTrigger = React.forwardRef(({ children, style, textStyle, ...props }, ref) => {
    ...
    return (<TouchableOpacity ref={ref} onPress={handlePress} activeOpacity={0.7} style={[styles.trigger, style]} {...props}>
...
export const AccordionContent = React.forwardRef(({ children, style, ...props }, ref) => {
    ...
    if (!isExpanded)
        return null;
    return (<Animated.View ref={ref} style={[styles.content, style]} {...props}>
        {children}
      </Animated.View>);
});
