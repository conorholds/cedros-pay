...
import { View, Text, TouchableOpacity, Modal, StyleSheet, Animated, Platform, Dimensions, } from 'react-native';
...
function ToastItem({ data, onDismiss, }) {
    ...
    return (<Animated.View style={[
      ...
      <View style={styles.actions}>
        {data.actionLabel && (<TouchableOpacity onPress={handleAction} style={styles.actionButton}>
...
export function ToastProvider({ children }) {
    ...
    return (<ToastContext.Provider value={{ toast }}>
      {children}
      <Modal visible={toasts.length > 0} transparent animationType="none" pointerEvents="box-none">
        <View style={styles.container} pointerEvents="box-none">
          <View style={styles.toastList} pointerEvents="auto">
