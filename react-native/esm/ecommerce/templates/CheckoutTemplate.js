...
export function CheckoutTemplate({ style, onContinueShopping, onViewOrders, onLogin, currentUrl, }) {
    ...
    return (<View style={[styles.container, style]}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        <CheckoutReceipt result={result} onContinueShopping={onContinueShopping} onViewOrders={onViewOrders}/>

        {result.kind === 'idle' ? (<View style={styles.checkoutContent}>
            ...
            <View style={styles.formContainer}>
              <CheckoutProvider>
                {shouldBlockForAuth ? (<Card style={styles.authCard}>
                    <CardHeader>
                    ...
                    <CardContent>
                      ...
                      {onLogin ? (<View style={styles.authButton}>
                          <Button onPress={onLogin}>
                            Sign in
                          </Button>
                        </View>) : null}
                    </CardContent>
                  </Card>) : (<CheckoutLayout left={<View style={styles.leftColumn}>
                        <CheckoutForm />
                      ...
                      </View>} right={<View style={styles.rightColumn}>
                        <OrderReview />
                      </View>}/>)}
              </CheckoutProvider>
            </View>
