...
function CheckIcon({ color }) {
    return (<View style={[styles.checkIcon, { backgroundColor: color }]}>
      <Text style={styles.checkText}>✓</Text>
    </View>);
}
export function SubscriptionTemplate({ style, title = 'Choose Your Plan', subtitle = 'Select the plan that best fits your needs.', annualSavingsBadge = '2 months free', popularBadgeText = 'Best Deal', footerNotice, onSelectTier, }) {
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.toggleContainer}>
          <View style={styles.toggleWrapper}>
            <TouchableOpacity onPress={() => setInterval('annual')} style={[
            styles.toggleButton,
            ...
            <TouchableOpacity onPress={() => setInterval('monthly')} style={[
            styles.toggleButton,
        ...
        {/* Loading State */}
        {isLoading ? (<View style={styles.skeletonGrid}>
            <Skeleton style={styles.skeletonCard}/>
            <Skeleton style={styles.skeletonCard}/>
            <Skeleton style={styles.skeletonCard}/>
          </View>) : tiers.length === 0 ? (<View style={styles.emptyContainer}>
            ...
            {tiers.map((tier) => {
                ...
                return (<Card key={tier.id} style={[
                  ...
                  <CardContent style={styles.cardContent}>
                    {/* Popular Badge */}
                    {isPopular && popularBadgeText && (<View style={styles.popularBadge}>
                    ...
                    {/* CTA Button */}
                    <Button variant={isPopular ? 'default' : 'outline'} disabled={isCurrent || isSoldOut} onPress={() => handleSelectTier(tier.id)} style={[
                        styles.ctaButton,
                    ...
                    {/* Features List */}
                    {regularFeatures.length > 0 && (<View style={styles.featuresList}>
                        {regularFeatures.map((feature, idx) => (<View key={idx} style={styles.featureRow}>
        ...
        {/* Footer Notice */}
        {footerNotice && (<View style={styles.footer}>
