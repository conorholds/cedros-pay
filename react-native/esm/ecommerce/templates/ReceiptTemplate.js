...
export function ReceiptTemplate({ order, source, purchaseId, customerEmail, customerName, style, onBack, onPrint, }) {
    ...
    return (<View style={[styles.container, style]}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          {onBack ? (<Button variant="ghost" size="sm" onPress={onBack}>
              ← Back
            </Button>) : (<View />)}
          {onPrint && (<Button variant="outline" size="sm" onPress={onPrint}>
              🖨️ Print Receipt
            </Button>)}
        </View>
      </View>
          ...
          <CardContent style={styles.receiptContent}>
            ...
            {(resolvedName || resolvedEmail) && (<>
                ...
                <View style={styles.customerSection}>
                  ...
                  {resolvedName && (<Text style={styles.customerName}>{resolvedName}</Text>)}
                  {resolvedEmail && (<Text style={styles.customerEmail}>{resolvedEmail}</Text>)}
                </View>
              </>)}
            ...
            <View style={styles.itemsSection}>
              ...
              {order.items.map((item, idx) => (<View key={`${item.title}-${idx}`} style={styles.tableRow}>
