 ...
 */
export function readCatalogUrlState({ url, includeCategory }) {
    if (!url)
        return null;
    try {
 ...
 */
export function buildCatalogUrl({ baseUrl, state, includeCategory }) {
 ...
 */
export function useCatalogUrlSync(state, { onStateChange, baseUrl, includeCategory }) {
