import type { Category, CartSnapshot, CustomerInfo, ListResult, Order, Product, ShippingMethod } from '../types';
...
export interface CommerceAdapter {
     ...
     */
    getCartInventoryStatus?(payload: {
        cartId: string;
...
//# sourceMappingURL=CommerceAdapter.d.ts.map