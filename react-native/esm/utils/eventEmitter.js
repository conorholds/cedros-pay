 ...
 */
export function emitPaymentStart(method, resource, itemCount) {
    emitEvent(CEDROS_EVENTS.PAYMENT_START, {
        timestamp: Date.now(),
        method,
        resource,
        itemCount,
 ...
 */
export function emitWalletConnect(wallet) {
    emitEvent(CEDROS_EVENTS.WALLET_CONNECT, {
        timestamp: Date.now(),
        wallet,
    });
}
 ...
 */
export function emitWalletConnected(wallet, publicKey) {
    emitEvent(CEDROS_EVENTS.WALLET_CONNECTED, {
        timestamp: Date.now(),
        wallet,
        publicKey,
    });
 ...
 */
export function emitWalletError(error, wallet) {
    emitEvent(CEDROS_EVENTS.WALLET_ERROR, {
        timestamp: Date.now(),
        wallet,
        error,
    });
 ...
 */
export function emitPaymentProcessing(method, resource, itemCount) {
    emitEvent(CEDROS_EVENTS.PAYMENT_PROCESSING, {
        timestamp: Date.now(),
        method,
        resource,
        itemCount,
 ...
 */
export function emitPaymentSuccess(method, transactionId, resource, itemCount) {
    emitEvent(CEDROS_EVENTS.PAYMENT_SUCCESS, {
        timestamp: Date.now(),
        method,
        transactionId,
        resource,
 ...
 */
export function emitPaymentError(method, error, resource, itemCount) {
    emitEvent(CEDROS_EVENTS.PAYMENT_ERROR, {
        timestamp: Date.now(),
        method,
        error,
        resource,
