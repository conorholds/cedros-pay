 ...
 */
export function isButtonInCooldown(buttonId) {
 ...
 */
export function setButtonCooldown(buttonId, cooldownMs = DEFAULT_COOLDOWN_MS) {
 ...
 */
export function isDuplicateRequest(requestId, windowMs = DEFAULT_DEDUP_WINDOW_MS) {
 ...
 * @param requestId - Unique request identifier
 */
export function markRequestProcessed(requestId) {
 ...
 */
export function getInFlightRequest(requestId) {
 ...
 */
export function trackInFlightRequest(requestId, promise) {
 ...
 * ```
 */
export async function deduplicateRequest(requestId, executor, options = {}) {
 ...
 * ```
 */
export function createDedupedClickHandler(buttonId, handler, options = {}) {
