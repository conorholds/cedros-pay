 ...
 */
import { PaymentError, PaymentErrorCode } from '../types/errors';
/**
...
export async function parseErrorResponse(response) {
    ...
    try {
        ...
        return new PaymentError(PaymentErrorCode.INTERNAL_ERROR, body.error || body.message || 'An unknown error occurred', false, undefined, httpStatus);
    }
    catch (parseError) {
        // Failed to parse JSON - use status text
        return new PaymentError(PaymentErrorCode.INTERNAL_ERROR, response.statusText || 'Request failed', false, undefined, httpStatus);
    }
}
/**
