 ...
 * // Returns: []
 */
export function parseCouponCodes(metadata) {
 ...
 * // Returns: "SITE10, CRYPTO5AUTO, SAVE20"
 */
export function formatCouponCodes(coupons, separator = ", ") {
 ...
 * // Returns: 25.0
 */
export function calculateDiscountPercentage(originalAmount, discountedAmount) {
    if (originalAmount <= 0)
        return 0;
 ...
 * // Returns: 70.50
 */
export function stackCheckoutCoupons(subtotal, checkoutCoupons) {
