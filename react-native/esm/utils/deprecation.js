 ...
 * ```
 */
export function logDeprecation(info) {
...
export function deprecate(fn, info) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return ((...args) => {
        logDeprecation(info);
        return fn(...args);
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function deprecateClass(Class, info) {
 ...
 * ```
 */
export function deprecateExport(value, info) {
