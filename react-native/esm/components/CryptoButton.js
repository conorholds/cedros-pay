 ...
 */
export function CryptoButton({ resource, items, label, disabled = false, onAttempt, onSuccess, onError, style, textStyle, loadingColor = '#ffffff', hideMessages = false, metadata, couponCode, }) {
    ...
    const handlePress = useMemo(() => createDedupedClickHandler(buttonId, executePaymentFlow, {
        cooldownMs: 200,
    ...
    return (<View style={[styles.container, style]}>
      ...
      {!hideMessages && transactionId && (<Text style={[styles.successText, { color: theme.tokens?.successText || '#22c55e' }]}>
