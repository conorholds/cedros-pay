 ...
 */
export function StripeButton({ resource, items, successUrl, cancelUrl, metadata, customerEmail, couponCode, label, disabled = false, onAttempt, onSuccess, onError, style, textStyle, loadingColor = '#ffffff', }) {
    ...
    const handlePress = useMemo(() => createDedupedClickHandler(buttonId, executePayment), [buttonId, executePayment]);
    ...
    return (<View style={[styles.container, style]}>
      ...
      {transactionId && (<Text style={[styles.successText, { color: theme.tokens?.successText || '#22c55e' }]}>
