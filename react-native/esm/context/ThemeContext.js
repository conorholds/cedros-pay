...
const CedrosThemeContext = createContext(null);
...
export function CedrosThemeProvider({ initialMode = 'light', overrides, unstyled = false, children, }) {
 ...
 */
export function useCedrosTheme() {
 ...
 */
export function useCedrosThemeOptional() {
